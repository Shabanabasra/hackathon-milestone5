...
form2.addEventListener(`submit`,(event:Event)=> {
    ...
    //Save form data in localStorage with the username as te key
...
window.addEventListener(`DOMContentLoaded`,()=> {
  ...
  if(username) {
    //Autofill form if data is found localStorage
    ...
    if(saveResumeData) {
        ...
        (document.getElementById(`experience`) as HTMLTextAreaElement).value =resumeData.education;
